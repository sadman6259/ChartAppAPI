...
namespace BuildingAppSample.Models
{
    public partial class BuildingContext : DbContext
    {
        ...
        public BuildingContext(IConfiguration config)
        {
            this.config = config;
        ...
        public virtual DbSet<BuildingDTO> BuildingDTO { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer(config.GetConnectionString("Building"));
